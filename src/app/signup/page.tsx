      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-ink-100 to-white">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border border-ink-100">
            <h1 className="display text-2xl mb-2">Criar conta grátis</h1>
            <p className="text-sm text-gray-600 mb-6">
              Comece a trocar hoje. Cadastro em 30 segundos.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div>
                ...
                <Input id="nome" required value={nome} onChange={(e) => setNome(e.target.value)} placeholder="Como gosta de ser chamado" />
              </div>
              <div>
            ...
            <p className="mt-4 text-center text-sm text-gray-600">
              Já tem conta? <Link href="/login" className="text-brand-green font-medium hover:underline">Entrar</Link>
            </p>
